...
const getInputPath = (p, prefix = 'problem', inputPath = 'input') => {
  if (p) {
...
const main = () => {
  ...
  if (problem) {
    ...
    const inputFile = getInputPath(problem)
    ...
    console.error(`ERROR: make sure ${problem} is a valid problem identifier`)
    process.exit(1)
  }
}
